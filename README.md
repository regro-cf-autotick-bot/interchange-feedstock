...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/interchange-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14182&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/interchange-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `interchange` can be installed with:

```
conda install interchange
```

It is possible to list all of the versions of `interchange` available on your platform with:
